...
name: huashu-design
description: >-
  花叔Design——用HTML做高保真原型、交互Demo、幻灯片、动画和解说视频，兼设计方向顾问与专家评审。触发词：做原型、交互Demo、UI
  mockup、app原型、iOS原型、HTML演示、幻灯片、动画Demo、导出MP4/GIF、解说视频、设计变体、设计风格/方向/配色、做个好看的、做个可视化、评审设计、review
  this design。含反AI slop清单、Starter Components、Playwright验证；需求模糊时先推荐3个差异化设计方向再并行做Demo。
---
